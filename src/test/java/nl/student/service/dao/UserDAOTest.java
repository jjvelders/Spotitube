...
import nl.student.services.doa.mssql.UserDAO;
...
public class UserDAOTest {
    ...
    public void getByToken(){
        ...
        UserEntity userEntity;
        //ACT
        userEntity = sut.getUserByToken(UUID.fromString("69abb76b-115b-4fef-961b-375faef8f945"));
        //ASSERT
        assertEquals("69abb76b-115b-4fef-961b-375faef8f945",userEntity.getToken());
    }
    ...
    public void checkIfFalseTokenExists(){
        ...
        boolean bool;
        //ACT
        bool = sut.checkIfValidToken(UUID.fromString("69abb76b-115b-4fef-961b-375faef8f946"));
